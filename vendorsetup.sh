...
# Custom pic for the maintainer's info in about section
	export OF_MAINTAINER_AVATAR="$PWD/device/realme/MTK6853/maintainer.png"
	
# Device Information.
	export FOX_ARCH=arm64
	export FOX_VARIANT="A12_FBEv1"
	export TARGET_DEVICE_ALT="MTK6853,MTK6853L1,MTK6853,MTK6853CN" # I am not what are the over possible names.
